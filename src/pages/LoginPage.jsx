...
import {
  ...
  ShieldCheck, RefreshCw, Check, AlertCircle
} from "lucide-react";
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fffe] text-slate-800 flex items-center justify-center p-3.5 sm:p-6 relative overflow-hidden select-none">
      
      {/* Background Neural Wings Image (loginbackground.png) */}
      ...
      {/* Ambient Mesh Glow */}
      <div className="absolute top-0 right-1/4 w-[400px] sm:w-[500px] h-[400px] sm:h-[500px] bg-cyan-200/30 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-0 left-1/4 w-[400px] sm:w-[500px] h-[400px] sm:h-[500px] bg-purple-200/30 rounded-full blur-[140px] pointer-events-none" />
      ...
      <motion.div
        ...
        className="w-full max-w-lg rounded-3xl bg-white/95 backdrop-blur-md border border-slate-200/80 p-5 sm:p-10 shadow-2xl relative z-10 text-left"
      >
        {/* Top Header: Back Link & Logo Image */}
        <div className="flex items-center justify-between mb-5 sm:mb-6">
          <Link
            to="/"
            className="inline-flex items-center gap-1.5 text-xs font-bold text-[#0d9488] hover:text-[#0f766e] transition-colors group"
          >
          ...
          <img
            src={LogoJpeg}
            alt="Logo"
            className="h-9 sm:h-10 w-auto object-contain rounded-xl shadow-sm"
          />
        </div>

        {/* Mode Switcher Tabs */}
        <div className="bg-slate-100 p-1 rounded-2xl border border-slate-200 flex mb-5">
          <button
            type="button"
        ...
        {/* Dynamic Titles */}
        <div className="mb-5">
          <h2 className="text-xl sm:text-2xl font-bold font-serif italic text-slate-900">
        ...
        {mode !== "reset" && (
          <div className="grid grid-cols-2 gap-2.5 mb-4 sm:mb-5">
            <button
              type="button"
              className="flex items-center justify-center gap-2 py-2.5 px-3 rounded-xl bg-slate-50 border border-slate-200 text-xs font-bold text-slate-700 hover:bg-slate-100 transition-all"
            >
        ...
        {isSuccess && (
          <div className="mb-4 p-3 rounded-xl bg-teal-50 border border-teal-200 text-cyan-700 text-xs flex items-center gap-2 font-medium">
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:border-cyan-500"
                />
              </div>
            </div>
          )}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:border-cyan-500"
                />
                <button
                  type="button"
          ...
          <div className="pt-1.5">
            <div className="p-2.5 sm:p-3 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-between">
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-[11px] sm:text-xs text-slate-700 font-semibold">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-3 rounded-xl bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-600 text-white font-bold text-xs shadow-md hover:opacity-95 transition-all flex items-center justify-center gap-2 mt-2"
          >
            {isLoading ? (
