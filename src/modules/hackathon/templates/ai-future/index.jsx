...
import AIFutureNavbar from "./components/Navbar.jsx";
import AIFutureHero from "./sections/Hero.jsx";
...
export default function AIFutureTemplate({ eventData, activeSubpage, setActiveSubpage, onRegisterClick }) {
  return (
    <div className="space-y-12 text-left text-white bg-slate-950 font-sans">
      <AIFutureNavbar title={eventData.title} activeSubpage={activeSubpage} setActiveSubpage={setActiveSubpage} />
