...
export default function AIFutureHero({ eventData, onRegisterClick }) {
  ...
  return (
    <section className="p-8 sm:p-14 rounded-3xl bg-slate-900 border border-slate-800 shadow-2xl relative overflow-hidden text-left text-white font-sans">
      ...
      <div className="relative z-10 space-y-6 max-w-4xl">
        ...
        <div className="pt-4 border-t border-slate-800 grid grid-cols-2 sm:grid-cols-4 gap-4 text-center font-mono">
          ...
          <div className="p-3.5 rounded-2xl bg-slate-950 border border-slate-800">
            <span className="text-[10px] text-slate-500 block uppercase font-bold">DEADLINE</span>
