    ...
    <section className="bg-white text-[#111] py-12 md:py-24 px-4 sm:px-6 md:px-12 font-sans selection:bg-black selection:text-white overflow-hidden">
      <style>{`
        ...
        @media (max-width: 640px) {
          .isometric-layer {
            transform: rotateX(35deg) rotateZ(-15deg) scale(0.85);
          }
        }
        .isometric-card {
        ...
        /* Custom scrollbar styling for topic list */
        ...
        @media (prefers-reduced-motion: reduce) {
          .isometric-layer { transform: none !important; }
          .isometric-card { transform: none !important; }
          .dashed-connector { animation: none !important; }
        }
      `}</style>

      <div className="mx-auto max-w-[1400px]">
        {/* Header */}
        <div className="mb-12 md:mb-16 border-b border-black/10 pb-6 md:pb-8">
          <p className="text-xs font-mono tracking-widest text-black/50 uppercase mb-3">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <p className="text-xs sm:text-sm text-black/60 max-w-sm leading-relaxed">
              Hands-on, AI-first workflows structured like full production stacks.
            </p>
          </div>
        </div>

        {/* Stack Architecture Section */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center my-8 md:my-12">
          
          {/* Left Column: Interactive Navigation Cards */}
          <div className="lg:col-span-5 flex flex-col gap-3 max-h-[480px] sm:max-h-[550px] lg:max-h-[620px] overflow-y-auto pr-2 custom-scrollbar order-2 lg:order-1">
          ...
          <div className="lg:col-span-7 relative h-[380px] sm:h-[480px] lg:h-[580px] flex items-center justify-center diagram-container overflow-hidden rounded-2xl border border-black/5 bg-[#fafafa] order-1 lg:order-2">
            ...
            {/* Isometric Layers */}
            <div className="isometric-layer relative w-[260px] h-[260px] sm:w-[320px] sm:h-[320px] md:w-[360px] md:h-[360px]">
                ...
                return (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <h4 className="text-sm sm:text-base font-bold text-[#111] tracking-tight leading-snug">{title}</h4>
                    </div>
                  </div>
                )
              })}
            ...
            <div className="absolute bottom-3 right-3 sm:bottom-4 sm:right-4 flex items-center gap-2 bg-white/90 backdrop-blur border border-black/10 px-3 py-1.5 rounded-full text-[10px] sm:text-[11px] font-mono text-black/60 shadow-sm z-10">
        ...
        <div ref={outcomesRef} className="mt-16 md:mt-24 border-t border-black/10 pt-12 md:pt-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-stretch">
            ...
            {/* Left Quote Card */}
            <div className="lg:col-span-6 bg-[#fafafa] border border-black/10 rounded-2xl p-6 sm:p-8 md:p-12 flex flex-col justify-between">
              <p className="text-xs font-mono text-black/40 uppercase tracking-widest">
                FROM THE COMMUNITY
              </p>
              <blockquote className="my-6 sm:my-8 text-xl sm:text-2xl md:text-3xl font-light text-[#111] leading-snug tracking-tight">
            ...
            {/* Right Metrics Card */}
            <div className="lg:col-span-6 border border-black/10 rounded-2xl p-6 sm:p-8 md:p-12 flex flex-col justify-between bg-white">
              <div>
                <p className="text-xs font-mono text-black/40 uppercase tracking-widest">
                  PROJECT OUTCOMES
                </p>
                <h3 className="text-xl sm:text-2xl md:text-3xl font-light text-[#111] mt-3 sm:mt-4 tracking-tight">
              ...
              <div className="grid grid-cols-3 gap-3 sm:gap-6 border-t border-black/10 pt-6 sm:pt-8 mt-6 sm:mt-8">
                {outcomes.map((o) => (
                  <div key={o.label}>
                    <p className="text-2xl sm:text-3xl md:text-4xl font-light tracking-tight text-[#111] font-mono">
                      <Counter value={o.value} suffix={o.suffix} active={activeOutcomes} />
                    </p>
                    <p className="mt-1.5 sm:mt-2 text-[11px] sm:text-xs text-black/50 leading-tight sm:leading-relaxed">{o.label}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-t border-black/10 pt-6 sm:pt-8">
            ...
            <a
              href="#cohorts"
              className="inline-flex items-center gap-2 text-xs sm:text-sm font-medium border-b border-black pb-0.5 hover:text-black/60 hover:border-black/60 transition-colors self-start sm:self-auto"
            >
              Explore our cohorts <span className="font-mono">↗</span>
            </a>
          </div>
        </div>
